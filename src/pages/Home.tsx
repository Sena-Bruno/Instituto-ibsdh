      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-brand-platinum max-w-xl mb-12 leading-relaxed font-light">
            O Instituto Bruno Sena desmistifica a Hipnoterapia, PNL e Coaching. Método estruturado, linguagem simples, resultados reais. Seja você terapeuta, coach, empresário, estudante ou simplesmente alguém em busca de autodomínio.
          </p>
        ...
        <div className="relative h-[450px] sm:h-[500px] lg:h-[600px] w-full max-w-[500px] lg:max-w-none mx-auto mt-12 lg:mt-0 flex items-end justify-center">
          ...
          >
            <div className="flex gap-3 sm:gap-4 items-center">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm font-bold text-white leading-tight">Hipnoterapia Clínica</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <p className="text-brand-dark font-bold text-[10px] sm:text-xs uppercase tracking-wider">Válido para uso</p>
              <p className="text-brand-dark/80 text-[8px] sm:text-[10px] font-medium uppercase">Profissional ou Pessoal</p>
            </div>
          </motion.div>
        </div>
      </div>
    ...
    <section className="py-20 bg-brand-dark relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {badges.map((badge, i) => (
            <div key={i} className="relative p-8 bg-white/5 border border-white/10 rounded-3xl hover:border-brand-accent/30 transition-all group">
              ...
              <p className="text-brand-accent font-bold text-sm uppercase tracking-wider mb-2">{badge.label}</p>
    ...
    <section className="py-20 bg-brand-surface border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <p className="text-brand-blue font-bold text-xs uppercase tracking-widest mb-3">Duas Trilhas, O Mesmo Resultado</p>
          <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-6">Para quem é o Instituto Bruno Sena?</h2>
          <p className="text-brand-platinum max-w-2xl mx-auto text-lg">
            Nossas formações são desenhadas tanto para quem busca uma transformação de vida, quanto para quem deseja construir uma carreira altamente lucrativa e com propósito.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-brand-dark border border-brand-accent/20 rounded-[32px] p-10 md:p-12 relative overflow-hidden group hover:border-brand-accent/40 transition-all shadow-[0_0_40px_rgba(229,195,101,0.05)]">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-display font-bold text-white mb-4">Desenvolvimento<br />Pessoal</h3>
              <p className="text-brand-platinum/90 leading-relaxed mb-8">
                Quebre ciclos de autossabotagem, elimine crenças limitantes e assuma o controle da sua mente e das suas emoções. 
                Uma jornada profunda de cura para construir a vida e os relacionamentos que você merece.
              </p>
          ...
          <div className="bg-brand-dark border border-brand-blue/20 rounded-[32px] p-10 md:p-12 relative overflow-hidden group hover:border-brand-blue/40 transition-all shadow-[0_0_40px_rgba(92,156,250,0.05)]">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-display font-bold text-white mb-4">Carreira &<br />Negócios</h3>
              <p className="text-brand-platinum/90 leading-relaxed mb-8">
                Construa uma carreira altamente lucrativa como Terapeuta ou Coach. 
                Aprenda ferramentas avançadas de transformação humana para aplicar em seus pacientes, clientes ou equipe corporativa.
              </p>
              <ul className="space-y-4">
                {[
...
const SenaSimulator = () => {
  return (
    <section id="sena" className="py-24 bg-brand-dark relative overflow-hidden border-t border-brand-accent/10">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              S.E.N.A. — Nosso Simulador <span className="text-brand-accent">Clínico com IA</span>
            </h2>
            <p className="text-brand-platinum text-lg leading-relaxed mb-8">
              O <strong>Sistema Evolutivo de Neuroaprendizagem Aplicada</strong> é o diferencial definitivo do Instituto. Você não vai apenas assistir aulas; você vai atender <strong>pacientes virtuais realistas</strong> e receber avaliação linha a linha por uma Inteligência Artificial treinada com a nossa metodologia.
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              {[
                { icon: <MessageSquare size={24} />, title: 'Simulação Bidirecional', desc: 'Atenda pacientes com voz ou texto em tempo real.' },
                { icon: <Activity size={24} />, title: '8 Perfis Clínicos', desc: 'Lide com pacientes ansiosos, céticos, evitativos e mais.' },
                { icon: <FileText size={24} />, title: 'Prontuário Automático', desc: 'IA gera o relatório de evolução após cada sessão.' },
                { icon: <Trophy size={24} />, title: 'Certificação Real', desc: 'O certificado é emitido com base em competência, não presença.' }
              ].map((feature, i) => (
                <div key={i} className="flex flex-col bg-brand-surface border border-white/5 p-6 rounded-2xl hover:border-brand-accent/30 transition-all">
                  <div className="text-brand-accent mb-4 bg-brand-accent/10 w-12 h-12 flex items-center justify-center rounded-xl">
                    {feature.icon}
                  </div>
                  <h4 className="text-white font-bold mb-2">{feature.title}</h4>
                  <p className="text-brand-platinum/70 text-sm leading-relaxed">{feature.desc}</p>
                </div>
              ))}
            </div>
              ...
              <div className="absolute inset-0 p-6 flex flex-col">
                ...
                <div className="flex-1 flex flex-col gap-4 overflow-hidden relative">
                  <div className="bg-white/5 border border-white/5 rounded-xl p-4 w-4/5 self-start">
                    <p className="text-brand-platinum/90 text-sm">Sinceramente, não sei se isso vai funcionar. Já tentei de tudo e essas técnicas parecem muito teóricas...</p>
                  </div>
                  <div className="bg-brand-accent/10 border border-brand-accent/20 rounded-xl p-4 w-4/5 self-end">
                    <p className="text-white text-sm">Entendo perfeitamente o seu ceticismo. Que tal testarmos algo prático agora mesmo para que você possa tirar suas próprias conclusões?</p>
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            <p className="text-brand-accent font-bold text-xs uppercase tracking-widest mb-3">Nossas Formações</p>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white">Escolha sua ferramenta de transformação</h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {courses.map((course, idx) => (
            ...
            >
              {course.popular && (
                <div className={`absolute top-0 right-0 ${course.colorBg} text-brand-dark text-[10px] font-bold uppercase tracking-wider py-1 px-3 rounded-bl-xl z-20`}>
                  Mais Popular
                </div>
              )}
              {course.advanced && (
              ...
              <div className="p-6 flex-1 flex flex-col">
                <div className="mb-4">
                  <p className={`${course.colorText} text-[10px] font-bold uppercase tracking-wider mb-2`}>{course.subtitle}</p>
                  ...
                  <div className="text-brand-platinum text-xs leading-relaxed space-y-2">
                    {course.desc.split('\n\n').map((paragraph, i) => (
                      <p key={i}>
                        <strong className="text-white">{paragraph.split(': ')[0]}:</strong> {paragraph.split(': ')[1]}
                      </p>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="flex flex-col gap-3 mt-auto pt-4 border-t border-white/10">
                    <div className="flex items-baseline gap-2 mb-1">
                      {course.comingSoon ? (
                        ...
                        <>
                          <span className="text-2xl font-bold text-white">{course.installments}</span>
                          <span className="text-[10px] text-brand-platinum">ou {course.price} à vista</span>
                        </>
                      )}
                    </div>
        ...
        <div className="mt-16 bg-brand-accent/10 border border-brand-accent/30 rounded-[32px] p-8 md:p-12 text-center max-w-4xl mx-auto relative overflow-hidden">
          ...
          <h3 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Trilogia IBSDH: A Jornada Completa</h3>
          <p className="text-brand-platinum/80 text-lg mb-8 max-w-2xl mx-auto">
            Practitioner + Master + Hipnoterapia. Domine todas as ferramentas de transformação e torne-se um Reprogramador de Elite com um desconto exclusivo.
          </p>
          <Link to="/jornada" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-brand-accent text-brand-dark rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-[0_0_30px_rgba(242,125,38,0.3)]">
            Ver Pacote Trilogia
            <ArrowRight size={20} />
          </Link>
        </div>
        ...
        <div className="mt-12 bg-brand-accent/10 border border-brand-accent/20 rounded-2xl p-6 md:p-8 text-center max-w-3xl mx-auto">
          ...
          <p className="text-brand-platinum leading-relaxed">
            Comece pelo <strong className="text-white">PNL Practitioner</strong>. É a base que torna todo o resto mais fácil. Muitos alunos fazem os três — e usam cada um para áreas diferentes da vida.
          </p>
        </div>
      </div>
    </section>
...
const ComoFunciona = () => {
  ...
  return (
    <section className="py-20 bg-brand-surface relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <p className="text-brand-blue font-bold text-xs uppercase tracking-widest mb-3">Como Funciona</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-white">Sua jornada de transformação</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, i) => (
            <div key={i} className="relative z-10 flex flex-col items-center text-center group">
              ...
              <p className="text-brand-platinum/80 text-sm leading-relaxed max-w-[250px]">{step.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="py-24 relative overflow-hidden bg-brand-dark">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <p className="text-brand-accent font-bold text-xs uppercase tracking-widest mb-3">Nosso Diferencial</p>
          <h2 className="font-display text-3xl md:text-5xl font-bold text-white">O que nos torna diferentes de qualquer curso de PNL ou Hipnose do mercado</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-brand-surface border border-brand-muted/20 rounded-[32px] p-10 relative overflow-hidden group hover:border-brand-purple/40 transition-all">
            ...
            <div className="relative z-10">
              ...
              <p className="text-brand-platinum/80 text-lg leading-relaxed mb-4 italic">Teoria sem prática é entretenimento. Prática sem método é acidente.</p>
              <p className="text-brand-platinum/80 text-lg leading-relaxed">
                Nosso sistema estrutura o aprendizado em 7 etapas progressivas. Você não apenas assiste , você <strong className="text-white">faz</strong>, <strong className="text-white">erra</strong>, <strong className="text-white">corrige</strong> e <strong className="text-white">domina</strong>. Desde a primeira aula.
              </p>
            </div>
          </div>
          ...
          <div className="bg-brand-surface border border-brand-muted/20 rounded-[32px] p-10 relative overflow-hidden group hover:border-brand-blue/40 transition-all">
            ...
            <div className="relative z-10">
              ...
              <p className="text-brand-platinum/80 text-lg leading-relaxed mb-4 italic">Descomplicamos o que é complexo, sem perder a profundidade.</p>
              <p className="text-brand-platinum/80 text-lg leading-relaxed">
                Não importa se você nunca estudou psicologia ou se já atua na área. Nosso método traduz conceitos avançados em passos acionáveis. <strong className="text-white">Terapeuta ou curioso, você entende e aplica.</strong>
              </p>
            </div>
          </div>
          ...
          <div className="md:col-span-3 bg-brand-surface border border-brand-muted/20 rounded-[32px] p-10 relative overflow-hidden group hover:border-brand-accent/30 transition-all">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
              <div className="flex-1">
                ...
                <p className="text-brand-platinum/80 text-lg leading-relaxed mb-4 italic">Use para si. Use para outros. Ou os dois.</p>
                <p className="text-brand-platinum/80 text-lg leading-relaxed">
                  Cada formação entrega certificado válido para:
                </p>
                <ul className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <li className="flex items-center gap-2 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0" size={18} /> Prática clínica profissional</li>
                  <li className="flex items-center gap-2 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0" size={18} /> Desenvolvimento pessoal e relacionamentos</li>
                  <li className="flex items-center gap-2 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0" size={18} /> Aplicação em negócios, vendas e liderança</li>
                  <li className="flex items-center gap-2 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0" size={18} /> Autoconhecimento profundo</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <section className="py-24 bg-brand-dark border-t border-brand-muted/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-6">Veja seus Certificados</h2>
          <p className="text-xl text-brand-platinum/80 max-w-3xl mx-auto leading-relaxed">
            Nossas titulações são documentos oficiais, chancelados por instituições renomadas e que atestam a sua capacidade técnica e prática.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-16 md:gap-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
             ...
             <div className="order-1 lg:order-2">
               ...
               <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">Certificação Internacional NLPEA</h3>
               <p className="text-brand-platinum/80 text-lg leading-relaxed mb-8">
                 Reconhecimento vitalício emitido pela <strong className="text-white">Neuro Linguistic Programming Excellence Assurance</strong>, com sede no Reino Unido. Seu passaporte global como profissional qualificado em PNL.
               </p>
               <ul className="space-y-4">
                 <li className="flex items-center gap-4 text-brand-platinum bg-white/5 p-4 rounded-2xl border border-white/5">
                   ...
                   <span className="font-medium">Válido internacionalmente em qualquer país</span>
                 </li>
                 <li className="flex items-center gap-4 text-brand-platinum bg-white/5 p-4 rounded-2xl border border-white/5">
                   <CheckCircle2 className="text-brand-blue shrink-0" size={24} /> 
                   <span className="font-medium">Registro único e vitalício na instituição britânica</span>
                 </li>
               </ul>
             </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
             <div>
               ...
               <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">Certificação Oficial IBSDH</h3>
               <p className="text-brand-platinum/80 text-lg leading-relaxed mb-8">
                 Certificado nacional com chancela do <strong className="text-white">Instituto Bruno Sena de Desenvolvimento Humano</strong>. Emitido com rigor apenas após avaliação de performance prática e aprovação no exame.
               </p>
               <ul className="space-y-4">
                 <li className="flex items-center gap-4 text-brand-platinum bg-white/5 p-4 rounded-2xl border border-white/5">
                   <CheckCircle2 className="text-brand-accent shrink-0" size={24} /> 
                   <span className="font-medium">Atesta competência clínica, técnica e ética</span>
                 </li>
                 <li className="flex items-center gap-4 text-brand-platinum bg-white/5 p-4 rounded-2xl border border-white/5">
                   <CheckCircle2 className="text-brand-accent shrink-0" size={24} /> 
                   <span className="font-medium">Permite atuação profissional imediata no Brasil</span>
                 </li>
               </ul>
             </div>
...
const Testimonials = () => {
  ...
  return (
    <section id="depoimentos" className="py-24 bg-brand-surface relative overflow-hidden border-t border-brand-blue/10">
      {/* Background Glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <p className="text-brand-blue font-bold text-xs uppercase tracking-widest mb-3">Prova Social Universal</p>
          <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-6">O que acontece quando você aplica o método</h2>
          <p className="text-brand-platinum max-w-2xl mx-auto text-lg">
            Resultados reais de alunos que aplicaram as técnicas de PNL e Hipnoterapia em suas vidas e profissões.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-brand-surface border border-brand-muted/20 rounded-3xl p-8 hover:border-brand-blue/30 transition-all flex flex-col h-full shadow-[0_4px_30px_rgba(0,0,0,0.1)] hover:-translate-y-1">
...
const Ebooks = () => {
  ...
  return (
    <section id="ebooks" className="py-20 bg-brand-surface relative overflow-hidden border-t border-brand-purple/10">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <p className="text-brand-purple font-bold text-xs uppercase tracking-widest mb-3">Entrada Acessível</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold mb-4 text-white">Comece com um investimento mínimo</h2>
          <p className="text-brand-platinum text-base max-w-2xl mx-auto">Quer conhecer nossa didática antes de se comprometer com uma formação completa?</p>
        </div>
    ...
    <section id="sobre-mentor" className="py-24 bg-brand-dark relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="block lg:hidden mb-10 text-center sm:text-left">
          <p className="text-brand-accent font-bold text-xs uppercase tracking-widest mb-4">O Seu Mentor</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-white leading-tight">"O método é o protagonista. Eu sou apenas o arquiteto."</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="hidden lg:block">
              <p className="text-brand-accent font-bold text-xs uppercase tracking-widest mb-4">O Seu Mentor</p>
              <h2 className="font-display text-4xl lg:text-5xl font-bold mb-6 text-white leading-tight">"O método é o protagonista. Eu sou apenas o arquiteto."</h2>
            </div>
            ...
            <div className="space-y-6 text-sm md:text-base text-brand-platinum leading-relaxed mb-10">
              ...
              <p>
                Passei os últimos anos desmontando as técnicas dos melhores profissionais em PNL, Hipnoterapia e Coaching do Brasil. Testei, falhei, refinei, sistematizei. O resultado é um método que funciona tanto para o terapeuta que quer cobrar R$500 por sessão, quanto para a pessoa que simplesmente quer parar de sabotar a própria vida.
              </p>
              <p>
                Não vendo transformação mágica. Entrego <strong className="text-white">ferramentas reproduzíveis</strong>.
              </p>
              <div className="border-l-2 border-brand-accent pl-6 py-2 my-8">
                <p className="text-white/80 italic text-sm md:text-base">
                  "Se você quer charlatanismo, existem milhares de 'gurus' por aí. Se quer estrutura que gera resultado, você está no lugar certo."
                </p>
              </div>
              ...
              <div className="mt-12 p-6 bg-white/5 border border-white/10 rounded-2xl flex flex-col sm:flex-row items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-brand-platinum leading-relaxed">
                    Reconhecimento internacional pela <strong className="text-white">Neuro Linguistic Programming Excellence Assurance</strong> (NLPEA). Uma certificação vitalícia que atesta não apenas o conhecimento teórico, mas a capacidade prática e ética na aplicação e ensino da Programação Neurolinguística em nível global.
                  </p>
                </div>
              </div>
...
const FAQ = () => {
  ...
  const faqs = [
    { q: "Preciso ser da área da saúde ou ter formação prévia?", a: "Não. Nossos alunos vão desde psicólogos até donos de pequenos negócios, de coaches a pessoas em transição de carreira. O método foi construído para ser acessível a qualquer pessoa com disposição para praticar." },
    { q: "Posso usar para atender outras pessoas profissionalmente?", a: "Sim. Todos os cursos entregam certificado válido para prática profissional. Porém, verifique a legislação específica da sua região. Algumas práticas podem exigir regulamentação adicional dependendo do estado." },
    { q: "E se eu quiser usar só para mim, para autoconhecimento?", a: "Perfeito. Muitos alunos fazem exatamente isso. As técnicas de reprogramação mental funcionam independentemente de quem está aplicando, em você ou em outros." },
    { q: "Os cursos são gravados ou ao vivo?", a: "100% gravados, com acesso vitalício. Você estuda no seu ritmo. Mas oferecemos encontros mensais ao vivo para tirar dúvidas — opcionais e gravados para quem não pode participar." },
    { q: "Tem garantia?", a: "7 dias de garantia incondicional. Acesse o conteúdo, teste o método. Se não fizer sentido para você, devolvemos 100%." },
    { q: "Qual a diferença entre PNL Practitioner e Master PNL?", a: "O Practitioner é a base completa. Tudo que você precisa para usar PNL com competência. O Master aprofunda técnicas avançadas, modelagem estratégica e estruturação de sessões profissionais de alto nível. Comece pelo Practitioner." }
  ];
    ...
    <section className="py-20 bg-white/5">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-12">
          <p className="text-brand-accent font-bold text-xs uppercase tracking-widest mb-3">Dúvidas Frequentes</p>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-white">Perguntas Comuns</h2>
        </div>
          ...
          {faqs.map((faq, i) => (
            <div key={i} className="border border-white/10 rounded-2xl overflow-hidden bg-white/5">
              ...
              >
                ...
                <ChevronRight className={cn("transition-transform text-brand-accent", openIndex === i ? "rotate-90" : "")} />
              </button>
              <AnimatePresence>
                {openIndex === i && (
                  <motion.div
...
const WhatsAppContact = () => {
  const message = encodeURIComponent("Olá! Gostaria de saber mais sobre as formações do Instituto Bruno Sena e como posso garantir minha vaga.");
  ...
  return (
    <section id="contato" className="py-20 bg-white/5 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
        <p className="text-brand-accent font-bold text-xs uppercase tracking-widest mb-3">Fale com Especialistas</p>
        <h2 className="font-display text-3xl md:text-5xl font-bold mb-6 text-white">Eleve o seu nível profissional</h2>
        <p className="text-base text-brand-platinum mb-10 max-w-2xl mx-auto leading-relaxed">
          Dúvidas sobre qual formação é a ideal para o seu momento? Nossa equipe está pronta para guiar seus próximos passos.
        </p>
...
const CorporateSolutions = () => {
  return (
    <section id="in-company" className="py-24 bg-brand-dark border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
              Treinamentos Corporativos de <span className="text-brand-emerald">Alto Impacto</span>
            </h2>
            <p className="text-brand-platinum text-lg leading-relaxed mb-8">
              A mesma metodologia que transforma vidas, agora formatada para resolver os maiores desafios da sua empresa. Aumente o engajamento, desenvolva líderes excepcionais e crie uma cultura de alta performance focada em resultados e inteligência emocional.
            </p>
            
            <ul className="space-y-6 mb-10">
              {[
                { title: 'Liderança Humanizada', desc: 'Ferramentas de Coaching e PNL para gestão de equipes.' },
                { title: 'Comunicação Assertiva', desc: 'Resolução de conflitos e negociação avançada.' },
                { title: 'Inteligência Emocional', desc: 'Controle de estresse e aumento de produtividade sob pressão.' }
              ].map((item, i) => (
      ...
      <main>
        ...
        <section className="py-24 px-6 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto bg-gradient-to-br from-brand-secondary/40 to-brand-accent/5 border border-white/10 rounded-[40px] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            <h2 className="font-display text-4xl md:text-6xl font-bold mb-6 text-white">Pronto para sua transformação?</h2>
            <p className="text-lg md:text-xl text-brand-platinum mb-10 max-w-2xl mx-auto">
              Comece hoje mesmo sua jornada no desenvolvimento humano com as melhores ferramentas do mercado.
            </p>
            <a href="#cursos" className="btn-primary inline-flex items-center gap-2 text-lg px-10 py-5">
