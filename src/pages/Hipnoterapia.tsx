...
const Hipnoterapia = () => {
  return (
    <div
      ...
      style={{ '--color-brand-accent': '#B67FF1' } as React.CSSProperties}
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Aprenda Hipnoterapia Clínica e tenha acesso direto ao inconsciente. Domine induções, protocolos terapêuticos e hipnose ericksoniana com o Instituto Bruno Sena."
        />
        <meta
          name="keywords"
          content="curso de hipnoterapia clínica, formação em hipnose, Hipnoterapia Clínica, Hipnose, Transe, Regressão, Instituto Bruno Sena"
        />
        <meta
          property="og:title"
        ...
        <meta
          ...
          content="Aprenda Hipnoterapia Clínica e tenha acesso direto ao inconsciente. Domine induções e protocolos terapêuticos."
        />
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-500/10 border border-red-500/30 text-red-400 text-sm font-medium mb-8">
            ...
            <span>
              Formação Responsável — 4 módulos de ética e limites. Não formamos amadores.
            </span>
          </div>
          ...
          <p className="text-lg text-brand-platinum/70 mb-12 max-w-3xl mx-auto">
            Aprenda a induzir transe terapêutico com segurança absoluta.{' '}
            <strong className="text-white">SENA Hipno:</strong> o único ambiente onde você
            pratica induções reais, testa profundidade e recebe feedback — sem risco para
            pessoas.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <div className="text-center sm:text-right">
              ...
              <div className="text-4xl font-bold text-white">12x R$ 32,50</div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">
              Em 7 módulos, você se torna capaz de:
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {[
              {
                title: 'Induzir transe terapêutico',
                desc: 'Do leve ao profundo, com segurança e controle',
              },
              {
                title: 'Aplicar protocolos específicos',
                desc: 'Ansiedade, fobias, hábitos, dor, insônia, performance',
              },
              {
                title: 'Conduzir regressão terapêutica',
                desc: 'Acessar e reprocessar memórias com ética absoluta',
              },
              {
                title: 'Usar hipnose conversacional',
                desc: 'Sugestão indireta em diálogo cotidiano (vendas, liderança)',
              },
              { title: 'Ensinar auto-hipnose', desc: 'Empoderar clientes para autonomia' },
              {
                title: 'Estruturar sessão completa',
                desc: 'Da anamnese à documentação, protegendo você e o cliente',
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-brand-dark p-6 rounded-3xl border border-white/10 flex items-start gap-4"
              >
          ...
          <div className="bg-red-500/10 border border-red-500/30 rounded-3xl p-8 max-w-4xl mx-auto text-center">
            ...
            <p className="text-brand-platinum/90">
              Você aprende <strong className="text-red-400">quando NÃO usar hipnose</strong>.
        ...
        <div className="max-w-5xl mx-auto px-6">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-brand-platinum/80">
                    Adiciona ferramenta de acesso direto ao inconsciente
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={20} />{' '}
                  <span className="text-brand-platinum/80">
                    Resolve em sessões o que levaria meses em abordagem puramente conversacional
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={20} />{' '}
                  <span className="text-brand-platinum/80">
                    Quer resultados mensuráveis para justificar valor premium
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 p-8 rounded-[32px] border border-white/10">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={20} />{' '}
                  <span className="text-brand-platinum/80">
                    Busca autodomínio profundo (auto-hipnose, regulação emocional)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={20} />{' '}
                  <span className="text-brand-platinum/80">
                    Quer entender a própria mente em nível inconsciente
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={20} />{' '}
                  <span className="text-brand-platinum/80">
                    Deseja ferramenta para performance, foco, eliminação de hábitos
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-brand-accent/10 border border-brand-accent/30 rounded-3xl p-8 text-center">
            ...
            <p className="text-brand-platinum/80">
              Hipnoterapia exige base de comunicação e leitura de padrões. Por isso,{' '}
              <strong className="text-white">PNL Practitioner é pré-requisito</strong>. Se você
              não tem,{' '}
              <Link to="/pnl-practitioner" className="text-brand-accent hover:underline">
                comece por lá
              </Link>
              . Se tem de outra formação, faça avaliação de entrada com SENA.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">
              100 horas. 44 aulas. Ética em primeiro lugar.
            </h2>
              ...
              [
                  ...
                  lessons: [
                    {
                      id: '1-6',
                      title:
                        'História, neurociência, mecanismos, mitos, estados de consciência',
                      practice: 'Quiz, discussão, identificação de mitos',
                    },
                    {
                      id: '7',
                      title: 'ÉTICA OBRIGATÓRIA — Limites legais e profissionais',
                      practice: 'Quiz 100% para liberar Módulo 2',
                      isEthic: true,
                    },
                  ],
                },
                {
                  ...
                  lessons: [
                    {
                      id: '8',
                      title: 'Preparo do cliente e ambiente',
                      practice: 'Simulação: cliente ansioso',
                    },
                    {
                      id: '9',
                      title: 'Indução Elman (fixação visual)',
                      practice: 'Indução em SENA + feedback de sinais',
                      isHighlight: true,
                    },
                    ...
                    {
                      id: '12',
                      title: 'Testes de profundidade',
                      practice: 'SENA em transe → você testa',
                    },
                    { id: '13', title: 'Deepeners', practice: 'Aprofundar transe induzido' },
                    {
                      id: '14',
                      title: 'Emergência segura',
                      practice: 'SENA como paciente → você emerge',
                    },
                    {
                      id: '15',
                      title: 'PRÁTICA INTEGRADA',
                      practice: 'Avaliação obrigatória: nota mínima 7/10',
                      isHighlight: true,
                    },
                  ],
                },
                {
                  ...
                  lessons: [
                    {
                      id: '16-22',
                      title: '7 protocolos específicos',
                      practice: 'Simulação de cada caso',
                    },
                    {
                      id: '23',
                      title: 'ÉTICA OBRIGATÓRIA — Quando NÃO usar hipnose',
                      practice: 'Quiz 100% + casos-teste',
                      isEthic: true,
                    },
                  ],
                },
                {
                  ...
                  lessons: [
                    {
                      id: '24-26',
                      title: 'Teoria, técnica, reprocessamento',
                      practice: 'Regressão simulada',
                    },
                    {
                      id: '27',
                      title: 'Falsas memórias: identificação e prevenção',
                      practice: 'Caso de risco',
                    },
                    {
                      id: '28',
                      title: 'ÉTICA CRÍTICA — Regressão e trauma',
                      practice: 'Casos-teste: faço ou encaminho?',
                      isEthic: true,
                    },
                    {
                      id: '29',
                      title: 'Integração pós-regressão',
                      practice: 'SENA pós-regressão',
                    },
                  ],
                },
                {
                  ...
                  lessons: [
                    {
                      id: '30-33',
                      title: 'Sugestão indireta, padrões Erickson, metáforas, aplicações',
                      practice: 'Criação e feedback',
                    },
                    {
                      id: '34',
                      title: 'ÉTICA — Influência e consentimento',
                      practice: 'Debate guiado',
                      isEthic: true,
                    },
                  ],
                },
                ...
                },
                {
                  ...
                  lessons: [
                    ...
                    {
                      id: '40',
                      title: 'Anamnese hipnótica',
                      practice: '3 históricos simulados',
                    },
                    {
                      id: '41',
                      title: 'Documentação e proteção legal',
                      practice: 'Preenchimento para caso SENA',
                    },
                    {
                      id: '42',
                      title: 'Precificação e posicionamento',
                      practice: 'Questionamento do SENA',
                    },
                    {
                      id: '43',
                      title: 'Atendimento online',
                      practice: 'Indução via simulação de vídeo',
                    },
                    {
                      id: '44',
                      title: 'EXAME FINAL',
                      practice: 'SENA como cliente complexo → nota mínima 7/10',
                      isHighlight: true,
                    },
                  ],
                },
              ...
              >
                <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                  <div>
                    ...
                    {mod.desc && (
                      <p className="text-sm text-brand-platinum/60 mt-1">{mod.desc}</p>
                    )}
                  </div>
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px]">
                      ...
                      <tbody className="text-brand-platinum text-sm">
                        {mod.lessons.map((lesson, lIdx) => (
                          <tr
                            key={lIdx}
                            className={`border-b border-white/5 hover:bg-white/5 transition-colors ${lesson.isEthic ? 'bg-red-500/5' : ''}`}
                          >
                            <td className="p-4 text-center font-mono text-brand-platinum/70">
                              {lesson.id}
                            </td>
                            <td
                              className={`p-4 font-medium ${lesson.isEthic ? 'text-red-400' : lesson.isHighlight ? 'text-white font-bold' : 'text-white'}`}
                            >
                              {lesson.title}
                            </td>
                            <td
                              className={`p-4 ${lesson.isEthic ? 'text-red-400 font-bold' : lesson.isHighlight ? 'text-brand-accent font-bold' : 'text-brand-accent'}`}
                            >
                              {lesson.practice}
                            </td>
                          </tr>
      ...
      <section className="py-24">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-6">
            Dois níveis. Um significa competência real.
          </h2>
              ...
              <thead>
                <tr className="border-b border-white/10 bg-black/20">
                  ...
                  <th className="p-6 w-3/8 border-l border-white/10 bg-brand-accent/5">
                    <div className="text-xl font-bold text-brand-accent mb-1">
                      Certificado de Hipnoterapeuta Clínico
                    </div>
                  </th>
                </tr>
              </thead>
              <tbody className="text-brand-platinum">
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-6 border-l border-white/10">
                    44 aulas + quizzes éticos 100%
                  </td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Exame 44 (nota 7/10) + 2 casos documentados
                  </td>
                </tr>
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5 font-bold text-white">
                    Indução real, profundidade testada, segurança comprovada
                  </td>
                </tr>
                <tr>
                  <td className="p-6 font-medium text-white">Alerta legal</td>
                  <td className="p-6 border-l border-white/10">—</td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5 text-sm">
                    Verifique legislação da sua região para prática clínica
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="mt-16 flex justify-center">
            <div className="w-full max-w-5xl relative">
              ...
              <img
                ...
                alt="Certificado de Hipnoterapeuta Clínico"
                className="w-full h-auto object-contain rounded-[32px] shadow-2xl relative z-10 border border-white/10"
                loading="lazy"
              />
            </div>
          </div>
      ...
      <section className="py-24 bg-brand-dark">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="bg-white/5 p-8 rounded-3xl border border-white/10 text-lg text-brand-platinum/80 leading-relaxed text-left space-y-4">
            ...
            <p>
              Se em 7 dias você não sentir que este é o{' '}
              <strong className="text-white">caminho mais seguro para dominar a hipnose</strong>
              , devolvemos 100%.
            </p>
            <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-xl mt-6">
              <p className="text-red-400 text-sm">
                <strong>Mas saiba:</strong> este curso{' '}
                <strong className="text-white">não deixa você avançar sem ética</strong>.
                Quizzes 100% são obrigatórios. Sua segurança e a do futuro cliente dependem
                disso.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-brand-dark text-white p-8 md:p-10 rounded-[40px] shadow-2xl">
              <div className="text-center mb-8">
                ...
                <div className="text-5xl font-bold text-white mb-2">12x R$ 32,50</div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-brand-platinum text-lg">
              Entenda a sinergia e as diferenças entre as abordagens.
            </p>
          </div>
            ...
            <table className="w-full text-left border-collapse min-w-[800px] bg-brand-dark rounded-[32px] overflow-hidden border border-white/10">
              ...
              <tbody className="text-brand-platinum">
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-6 border-l border-white/10">
                    Estrutura do pensamento e comportamento
                  </td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Estados de consciência e acesso inconsciente
                  </td>
                </tr>
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Acessar o modo de programação diretamente
                  </td>
                </tr>
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Mudanças em minutos (quando indicado)
                  </td>
                </tr>
                <tr className="border-b border-white/5">
                  <td className="p-6 font-medium text-white">Controle do cliente</td>
                  <td className="p-6 border-l border-white/10">
                    Ativo, consciente, participativo
                  </td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Dissociado leve, acesso a recursos automáticos
                  </td>
                </tr>
                <tr>
                  <td className="p-6 font-medium text-white">Profundidade</td>
                  <td className="p-6 border-l border-white/10">
                    Crenças, estratégias, identidade
                  </td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Emoções, memórias, padrões automáticos profundos
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="bg-brand-dark p-8 md:p-12 rounded-[40px] border border-white/10 text-center mb-16">
            ...
            <p className="text-xl text-brand-accent italic mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left">
              <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                ...
                <ul className="space-y-2 text-sm text-brand-platinum/80">
                  <li>
                    <strong className="text-white">PNL:</strong> Análise de crença ("aviões
                    caem"), Swish Pattern para imagem positiva
                  </li>
                  <li>
                    <strong className="text-white">Hipnoterapia:</strong> Desensibilização em
                    transe, ancoragem de calma para o dia do voo
                  </li>
                  <li className="text-brand-accent mt-2">
                    <strong>Resultado:</strong> Mudança estrutural (PNL) + recurso emocional sob
                    demanda (hipnose)
                  </li>
                </ul>
              </div>
              <div className="bg-white/5 p-6 rounded-2xl border border-white/10">
                ...
                <ul className="space-y-2 text-sm text-brand-platinum/80">
                  ...
                  <li>
                    ...
                    lugar de preocupação" → "cama como lugar de sono"
                  </li>
                  <li className="text-brand-accent mt-2">
                    <strong>Resultado:</strong> Transe para adormecer (hipnose) + reestruturação
                    do estímulo (PNL)
                  </li>
                </ul>
              </div>
          ...
          <div className="text-center">
            <p className="text-xl text-brand-platinum/80 italic max-w-3xl mx-auto mb-8">
              "PNL é a língua que falo com a mente consciente. Hipnoterapia é a língua que falo
              com a mente inconsciente. Fluente em ambas, sou bilíngue da transformação."
            </p>
