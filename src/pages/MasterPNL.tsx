  ...
  return (
    <div className="min-h-screen bg-brand-dark text-brand-platinum font-sans selection:bg-brand-accent selection:text-brand-dark">
      <Helmet>
        ...
        <meta
          name="description"
          content="Aprofunde seus conhecimentos em PNL com a Formação Master PNL. Domine a modelagem avançada, intervenções complexas e estruturação de sessões profissionais."
        />
        <meta
          name="keywords"
          content="master PNL online, PNL avançado certificação, Master PNL, Programação Neurolinguística Avançada, Instituto Bruno Sena"
        />
        <meta property="og:title" content="Formação Master PNL | Instituto Bruno Sena" />
        <meta
          property="og:description"
          content="Aprofunde seus conhecimentos em PNL com a Formação Master PNL. Domine a modelagem avançada e intervenções complexas."
        />
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-brand-platinum/70 mb-12 max-w-3xl mx-auto">
            Para quem já domina o básico e quer as técnicas que separam técnicos de
            estrategistas. <strong className="text-white">SENA Avançado:</strong> prática com
            casos de alta dificuldade, avaliação por decisão clínica, nota mínima 8/10 para
            certificação.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
            <div className="text-center sm:text-right">
              <div className="text-sm text-brand-platinum/60 line-through mb-1">
                De R$ 1.997
              </div>
              <div className="text-4xl font-bold text-white">12x R$ 87,50</div>
      ...
      <section className="py-24 bg-white/5 border-y border-white/10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-brand-platinum/80 leading-relaxed mb-12">
            ...
            emaranhadas ou quando a técnica "de livro" não funciona.
          </p>
          <div className="grid md:grid-cols-3 gap-6 text-left">
            <div className="bg-brand-dark p-6 rounded-3xl border border-white/10">
              ...
              <p className="text-brand-platinum/70 text-sm">
                Quando uma fobia esconde um ganho secundário profundo.
              </p>
            </div>
            <div className="bg-brand-dark p-6 rounded-3xl border border-white/10">
              <div className="text-brand-accent mb-4">
              ...
              <p className="text-brand-platinum/70 text-sm">
                Quando o cliente diz "sim" mas a fisiologia grita "não".
              </p>
            </div>
            <div className="bg-brand-dark p-6 rounded-3xl border border-white/10">
              <div className="text-brand-accent mb-4">
              ...
              <p className="text-brand-platinum/70 text-sm">
                Saber qual técnica usar, em qual ordem, e por quê.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">
              O arsenal de um Master
            </h2>
            <p className="text-brand-platinum text-lg">
              Técnicas avançadas validadas por simulação.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Extrair a estratégia de excelência de qualquer pessoa e instalá-la em si mesmo ou em clientes.',
              },
              {
                title: 'Linguagem Hipnótica (Milton)',
                desc: 'O uso avançado de padrões de linguagem para contornar o fator crítico com elegância.',
              },
              {
                title: 'Sleight of Mouth',
                desc: '24 padrões de linguagem para ressignificar crenças limitantes instantaneamente em conversas.',
              },
              {
                title: 'Metaprogramas',
                desc: 'Identificar os filtros inconscientes que determinam como uma pessoa decide, compra e se motiva.',
              },
              {
                title: 'Linha do Tempo Avançada',
                desc: 'Intervenções profundas no passado para liberar emoções negativas e criar um futuro compulsivo.',
              },
              {
                title: 'Valores e Critérios',
                desc: 'Alinhar conflitos internos profundos que sabotam o sucesso pessoal e profissional.',
              },
            ].map((item, i) => (
              <div
                key={i}
                className="bg-brand-dark p-8 rounded-[32px] border border-white/10 hover:border-brand-accent/50 transition-colors"
              >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-brand-platinum/80">
                  Esta formação assume que você já domina VAKOG, Rapport, Ancoragem e
                  Metamodelo. Se você não tem formação Practitioner (por nós ou outra
                  instituição), o SENA Avançado bloqueará seu progresso nas primeiras aulas.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/5 p-8 rounded-3xl border border-white/10">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Lidar
                  com clientes "difíceis" ou resistentes
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} />{' '}
                  Resultados mais rápidos em casos complexos
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} />{' '}
                  Aumentar o valor da sua hora/sessão
                </li>
              </ul>
            </div>
            <div className="bg-white/5 p-8 rounded-3xl border border-white/10">
              <h3 className="text-2xl font-bold text-brand-accent mb-4">
                Líderes e Negociadores
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} />{' '}
                  Persuasão invisível e ética (Sleight of Mouth)
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Modelar
                  a excelência de top performers
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} />{' '}
                  Resolução de conflitos de valores em equipes
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-24 bg-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">
              Ementa Master PNL (120h)
            </h2>
            <p className="text-brand-platinum text-lg">
              7 Módulos. 48 Aulas. Prática Avançada.
            </p>
          </div>
            ...
            {[
              {
                ...
                lessons: [
                  {
                    id: 1,
                    title: 'A Essência da Modelagem',
                    practice: 'Análise de vídeo de expert',
                  },
                  {
                    id: 2,
                    title: 'Extração de Estratégias (TOTE)',
                    practice: 'Simulação de entrevista de modelagem',
                  },
                  {
                    id: 3,
                    title: 'Instalação de Estratégias',
                    practice: 'Auto-instalação guiada',
                  },
                  {
                    id: 4,
                    title: 'Modelagem de Crenças',
                    practice: 'Identificação de crenças de suporte',
                  },
                  {
                    id: 5,
                    title: 'Projeto de Modelagem',
                    practice: 'Apresentação de caso ao SENA',
                  },
                ],
              },
              {
                ...
                lessons: [
                  {
                    id: 6,
                    title: 'O que são Metaprogramas',
                    practice: 'Quiz de identificação',
                  },
                  {
                    id: 7,
                    title: 'Direção (Aproximação vs. Afastamento)',
                    practice: 'Ajuste de copy/discurso',
                  },
                  {
                    id: 8,
                    title: 'Referência (Interna vs. Externa)',
                    practice: 'Simulação de feedback',
                  },
                  {
                    id: 9,
                    title: 'Tamanho do Chunk (Global vs. Específico)',
                    practice: 'Tradução de comunicação',
                  },
                  {
                    id: 10,
                    title: 'Perfilamento Rápido',
                    practice: 'Análise de 5 perfis complexos',
                  },
                ],
              },
              {
                ...
                lessons: [
                  {
                    id: 11,
                    title: 'Hierarquia de Valores',
                    practice: 'Eliciação de valores próprios',
                  },
                  {
                    id: 12,
                    title: 'Conflitos de Valores',
                    practice: 'Resolução de conflito simulado',
                  },
                  { id: 13, title: 'Mudança de Valores', practice: 'Intervenção ecológica' },
                  {
                    id: 14,
                    title: 'Alinhamento de Níveis Neurológicos',
                    practice: 'Prática de alinhamento completo',
                  },
                ],
              },
              {
                ...
                lessons: [
                  ...
                  {
                    id: 16,
                    title: 'Padrões de Intenção e Redefinição',
                    practice: 'Batalha de objeções com SENA',
                  },
                  {
                    id: 17,
                    title: 'Padrões de Consequência e Chunking',
                    practice: 'Batalha de objeções com SENA',
                  },
                  {
                    id: 18,
                    title: 'Padrões de Metáfora e Modelo de Mundo',
                    practice: 'Batalha de objeções com SENA',
                  },
                  {
                    id: 19,
                    title: 'Fluência em Sleight of Mouth',
                    practice: 'Simulação de venda/negociação',
                  },
                ],
              },
              {
                ...
                lessons: [
                  {
                    id: 20,
                    title: 'Transe e PNL',
                    practice: 'Identificação de estados de transe',
                  },
                  {
                    id: 21,
                    title: 'Padrões de Linguagem Indireta',
                    practice: 'Criação de roteiro hipnótico',
                  },
                  {
                    id: 22,
                    title: 'Comandos Ocultos e Marcação Analógica',
                    practice: 'Análise de discurso',
                  },
                  {
                    id: 23,
                    title: 'Metáforas Isomórficas',
                    practice: 'Criação de metáfora terapêutica',
                  },
                ],
              },
              {
                ...
                lessons: [
                  {
                    id: 24,
                    title: 'Reenquadramento em 6 Passos',
                    practice: 'Simulação de caso clínico',
                  },
                  {
                    id: 25,
                    title: 'Cura Rápida de Fobia',
                    practice: 'Simulação de caso clínico',
                  },
                  { id: 26, title: 'Swish Avançado', practice: 'Simulação de caso clínico' },
                  {
                    id: 27,
                    title: 'Terapia da Linha do Tempo',
                    practice: 'Simulação de caso clínico',
                  },
                  {
                    id: 28,
                    title: 'Integração de Partes',
                    practice: 'Simulação de caso clínico',
                  },
                ],
              },
              {
                ...
                lessons: [
                  {
                    id: 29,
                    title: 'Design de Intervenção',
                    practice: 'Criação de protocolo exclusivo',
                  },
                  {
                    id: 30,
                    title: 'Ecologia Profunda',
                    practice: 'Análise de impactos sistêmicos',
                  },
                  {
                    id: 31,
                    title: 'O Exame Master',
                    practice: 'Avaliação SENA (nota mínima 8/10)',
                  },
                ],
              },
            ].map((mod, idx) => (
                  ...
                  <table className="w-full text-left border-collapse min-w-[800px]">
                    ...
                    <tbody className="text-brand-platinum text-sm">
                      {mod.lessons.map((lesson, lIdx) => (
                        ...
                        >
                          <td className="p-4 text-center font-mono text-brand-platinum/70">
                            {lesson.id}
                          </td>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div className="bg-white/5 p-8 rounded-3xl border border-white/10 opacity-70">
              ...
              <p className="text-brand-platinum/70 text-sm mb-4">
                Emitido automaticamente ao assistir todas as aulas.
              </p>
              <div className="text-xs font-mono text-brand-platinum/50">
            ...
            <div className="bg-brand-accent/10 p-8 rounded-3xl border border-brand-accent/30 relative overflow-hidden flex flex-col gap-8">
              <div className="flex-1">
                ...
                <h3 className="text-2xl font-bold text-white mb-2 relative z-10 mt-4 md:mt-0">
                  Certificado de Competência Master
                </h3>
                <p className="text-brand-platinum/70 text-base mb-4 relative z-10">
                  Emitido apenas após aprovação no SENA Avançado (nota mínima 8/10) e submissão
                  de projeto de modelagem.
                </p>
                <div className="text-sm font-mono text-brand-accent relative z-10">
                  Valor de mercado: Elite
                </div>
              </div>
              <div className="w-full relative z-10">
                <img
                  src="/Certificado-IBSDH.webp"
                  alt="Certificado Master PNL"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-brand-dark p-8 rounded-3xl border border-white/10">
              ...
              <p className="text-brand-platinum/80 italic mb-6">
                "O módulo de Sleight of Mouth mudou minhas negociações. Consigo desarmar
                objeções de clientes high-ticket antes mesmo que eles percebam. O SENA me
                treinou para ser rápido."
              </p>
            ...
            <div className="bg-brand-dark p-8 rounded-3xl border border-white/10">
              ...
              <p className="text-brand-platinum/80 italic mb-6">
                "Sou terapeuta há 10 anos. O Master me deu a estrutura para casos que antes me
                travavam. A avaliação do SENA é rigorosa, reprovei duas vezes, mas quando
                passei, sabia que estava pronta."
              </p>
              <div className="font-bold text-white">Ana P.</div>
              <div className="text-sm text-brand-platinum/60">
                Psicanalista e Master Practitioner
              </div>
            </div>
            <div className="bg-brand-dark p-8 rounded-3xl border border-white/10">
              <div className="flex text-brand-accent mb-4">
              ...
              <p className="text-brand-platinum/80 italic mb-6">
                "A modelagem comportamental é um superpoder. Usei as técnicas do módulo 1 para
                modelar o melhor gestor da minha empresa. Fui promovido em 6 meses."
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-brand-dark text-white p-8 md:p-10 rounded-[40px] shadow-2xl">
              <div className="text-center mb-8">
                <div className="text-brand-platinum/60 line-through mb-2">
                  De {courses.masterPnl.priceFrom}
                </div>
              ...
              <div className="bg-white/5 p-4 rounded-2xl border border-white/10 text-sm text-brand-platinum/80 text-center">
                <strong className="text-brand-accent block mb-1">Atenção:</strong>O acesso ao
                SENA Avançado requer conhecimento prévio de PNL.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white/5 border-t border-white/10">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-brand-platinum text-lg">
              Compare as formações e escolha seu nível de profundidade.
            </p>
          </div>
              ...
              <thead>
                <tr className="border-b border-white/10 bg-black/20">
                  ...
                  <th className="p-6 w-3/8 border-l border-white/10">
                    ...
                    <div className="text-sm text-brand-platinum/60 font-normal">
                      O Fundamento
                    </div>
                  </th>
              ...
              <tbody className="text-brand-platinum">
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-6 border-l border-white/10">
                    Aprender o vocabulário, aplicar técnicas base, resolver questões pontuais.
                  </td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Fluência, estratégia, casos complexos, modelagem de excelência.
                  </td>
                </tr>
                <tr className="border-b border-white/5">
                  <td className="p-6 font-medium text-white">Ementa</td>
                  <td className="p-6 border-l border-white/10">
                    VAKOG, Rapport, Metamodelo, Ancoragem, Cura de Fobia simples.
                  </td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Metaprogramas, Valores, Sleight of Mouth, Modelo Milton, Modelagem.
                  </td>
                </tr>
                <tr className="border-b border-white/5">
                  <td className="p-6 font-medium text-white">SENA (Simulador)</td>
                  <td className="p-6 border-l border-white/10">
                    SENA Básico: Guia paciente, corrige erros de estrutura, foca no aprendizado.
                  </td>
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    SENA Avançado: Cliente resistente, avalia estratégia, exige ecologia.
                  </td>
                </tr>
                <tr className="border-b border-white/5">
                  ...
                  <td className="p-6 border-l border-white/10 bg-brand-accent/5">
                    Nota mínima 8/10 + Projeto de Modelagem.
                  </td>
                </tr>
                <tr>
