...
const FixedWhatsApp = () => {
  ...
  return (
    ...
    >
      <span aria-hidden="true" className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-20 group-hover:opacity-40 motion-reduce:hidden" />
      ...
      <span className="sr-only">Falar com o Instituto no WhatsApp</span>
      <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" width="28" height="28" fill="currentColor">
