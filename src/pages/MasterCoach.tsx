...
import { Briefcase, CheckCircle2, Clock, Target, TrendingUp, Users2 } from 'lucide-react';
...
const MasterCoach = () => {
  return (
    <div
      ...
      style={{ '--color-brand-accent': '#39D4A1' } as React.CSSProperties}
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Torne-se um Master Coach de excelência. Aprenda ferramentas poderosas de liderança, gestão e desenvolvimento humano para transformar vidas e negócios."
        />
        <meta
          name="keywords"
          content="curso de master coach online, Master Coach, Coaching, Liderança, Desenvolvimento Pessoal, Gestão, Instituto Bruno Sena"
        />
        <meta property="og:title" content="Formação Master Coach | Instituto Bruno Sena" />
        <meta
          property="og:description"
          content="Torne-se um Master Coach de excelência. Aprenda ferramentas poderosas de liderança e gestão."
        />
      ...
      <section className="pt-32 pb-20 md:pt-40 md:pb-32 px-6 relative overflow-hidden min-h-screen flex flex-col justify-center">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Eleve seus atendimentos ao nível de excelência. Ferramentas sistêmicas, liderança e
          ...
          >
            Estamos preparando a formação mais completa do mercado para coaches que desejam se
            destacar, lotar suas agendas e gerar resultados extraordinários para seus clientes.
          </motion.p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <p className="text-brand-platinum/70 leading-relaxed">{item.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col gap-12 items-center text-center">
            <div className="flex-1 max-w-4xl">
              <h2 className="font-display text-3xl md:text-5xl font-bold text-white mb-6">
                A Mais Alta Titulação
              </h2>
              <p className="text-xl text-brand-platinum/90 mb-8 leading-relaxed">
                Nossa certificação de Coach Profissional é o atestado definitivo da sua
                capacidade de conduzir processos de transformação profunda com segurança, método
              ...
              <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-8 mb-8 text-left">
                <li className="flex items-center gap-3 text-brand-platinum">
                  <CheckCircle2 className="text-brand-accent shrink-0" size={20} /> Certificado
                  Válido Nacionalmente
                </li>
                <li className="flex items-center gap-3 text-brand-platinum">
                  <CheckCircle2 className="text-brand-accent shrink-0" size={20} /> Chancelado
                  pelo IBSDH
                </li>
                <li className="flex items-center gap-3 text-brand-platinum">
                  <CheckCircle2 className="text-brand-accent shrink-0" size={20} /> Foco em
                  Resultados Clínicos e Sistêmicos
                </li>
              </ul>
            </div>
            <div className="w-full max-w-5xl relative">
              ...
              <img
                ...
                alt="Certificado de Coach Profissional"
