  ...
  return (
    <div className="min-h-screen bg-brand-dark text-brand-platinum font-sans" style={{ '--color-brand-accent': '#5C9CFA' } as React.CSSProperties}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-brand-platinum/80 mb-8 leading-relaxed">
                Domine a linguagem da mente e reprograme padrões limitantes, em você ou em qualquer pessoa. Método estruturado, direto e aplicável. Do zero à competência em reprogramação mental. <strong className="text-white">Com o SENA, seu parceiro de prática 24/7.</strong> Sem jargões incompreensíveis, sem promessas místicas. Apenas técnica que funciona.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center">
                ...
                <div className="text-brand-accent font-bold text-lg">
                  12x de R$ 24,75 <span className="text-sm font-normal text-brand-platinum">ou R$ 297 à vista</span>
                </div>
              </div>
              <p className="text-xs text-brand-platinum/60 mt-4 italic">
                * Turma com acompanhamento ativo. Vagas limitadas para garantir qualidade no suporte.
              </p>
              <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-brand-platinum text-sm">
                ...
                <span><strong className="text-white">Powered by SENA</strong>. Pratique com IA ilimitada incluída</span>
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-white/5 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Em 7 módulos, você sai apto a:</h2>
          </div>
          ...
          <div className="bg-brand-accent/10 border border-brand-accent/20 rounded-[32px] p-8 md:p-12 text-center max-w-4xl mx-auto">
            <p className="text-lg text-brand-platinum leading-relaxed">
              ...
              <strong className="text-white">E o mais importante:</strong> você não apenas "aprende" — você <strong className="text-brand-accent">pratica</strong>. O SENA, nosso agente de IA, simula situações reais para você treinar quantas vezes quiser, com feedback instantâneo, sem depender de ninguém.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-brand-dark relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Este curso foi feito para você que:</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="p-10 bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-[32px] relative overflow-hidden group">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Quer parar de sabotar seus próprios objetivos</li>
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Deseja melhorar relacionamentos e comunicação</li>
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Busca autoconhecimento profundo e prático</li>
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Quer ferramentas para gerenciar ansiedade e estresse</li>
              </ul>
            </div>
            ...
            <div className="p-10 bg-gradient-to-br from-white/5 to-transparent border border-white/10 rounded-[32px] relative overflow-hidden group">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> É terapeuta e quer adicionar PNL à sua caixa de ferramentas</li>
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> É coach e precisa de resultados mais rápidos para clientes</li>
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Trabalha com vendas, RH ou liderança</li>
                <li className="flex items-start gap-3 text-brand-platinum/80"><CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={18} /> Quer construir uma carreira em desenvolvimento humano</li>
              </ul>
            </div>
          </div>

          <div className="text-center mb-12">
            <p className="text-brand-accent font-bold text-xl max-w-2xl mx-auto">"Não importa seu objetivo. As ferramentas são as mesmas. O que muda é onde você aplica."</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white/5 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Conteúdo programático, sem filler, só o que funciona</h2>
            <p className="text-brand-platinum text-lg">Cada módulo inclui <strong className="text-white">demonstrações em vídeo + prática com SENA</strong> conforme ementa oficial IBSDH.</p>
          </div>

          <div className="space-y-12 mb-20">
            {/* Módulo 1 */}
            <details className="bg-brand-dark border border-white/10 rounded-[32px] overflow-hidden group" open>
              <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                <h3 className="text-xl font-bold text-brand-accent">MÓDULO 1: ORIGENS E FUNDAMENTOS (14h)</h3>
            ...
            <details className="bg-brand-dark border border-white/10 rounded-[32px] overflow-hidden group">
              <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                <h3 className="text-xl font-bold text-brand-accent">MÓDULO 2: SISTEMAS REPRESENTACIONAIS E ACUIDADE (14h)</h3>
                <ChevronDown className="text-brand-accent transition-transform group-open:rotate-180" />
              </summary>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[800px]">
            ...
            <details className="bg-brand-dark border border-white/10 rounded-[32px] overflow-hidden group">
              <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                <h3 className="text-xl font-bold text-brand-accent">MÓDULO 3: A ESTRUTURA DA LINGUAGEM (14h)</h3>
                <ChevronDown className="text-brand-accent transition-transform group-open:rotate-180" />
              </summary>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[800px]">
            ...
            <details className="bg-brand-dark border border-white/10 rounded-[32px] overflow-hidden group">
              <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                <h3 className="text-xl font-bold text-brand-accent">MÓDULO 4: ENGENHARIA EMOCIONAL (14h)</h3>
                <ChevronDown className="text-brand-accent transition-transform group-open:rotate-180" />
              </summary>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[800px]">
            ...
            <details className="bg-brand-dark border border-white/10 rounded-[32px] overflow-hidden group">
              <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                <h3 className="text-xl font-bold text-brand-accent">MÓDULO 5: SUBMODALIDADES — O CÓDIGO INTERNO (16h)</h3>
                <ChevronDown className="text-brand-accent transition-transform group-open:rotate-180" />
              </summary>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[800px]">
            ...
            <details className="bg-brand-dark border border-white/10 rounded-[32px] overflow-hidden group">
              <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                <h3 className="text-xl font-bold text-brand-accent">MÓDULO 6: PROTOCOLOS TERAPÊUTICOS (16h)</h3>
                <ChevronDown className="text-brand-accent transition-transform group-open:rotate-180" />
              </summary>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[800px]">
            ...
            <details className="bg-brand-dark border border-white/10 rounded-[32px] overflow-hidden group">
              <summary className="bg-white/5 p-6 border-b border-white/10 cursor-pointer flex justify-between items-center list-none [&::-webkit-details-marker]:hidden">
                <h3 className="text-xl font-bold text-brand-accent">MÓDULO 7: DO ALUNO AO PROFISSIONAL DE ELITE (12h)</h3>
                <ChevronDown className="text-brand-accent transition-transform group-open:rotate-180" />
              </summary>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-[800px]">
              ...
              <div className="bg-brand-dark border border-brand-accent/30 rounded-[40px] p-8 md:p-12 text-center shadow-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-8">
                  <div className="flex items-start gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
                    ...
                    <p className="text-brand-platinum">Apostila completa em PDF (conforme ementa oficial IBSDH)</p>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
                    <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={20} />
                    <p className="text-brand-platinum">Biblioteca de demonstrações práticas das 44 aulas</p>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-brand-accent/10 rounded-2xl border border-brand-accent/30">
                    <span className="text-xl shrink-0 mt-0.5">🤖</span>
                    <p className="text-white font-bold">SENA: prática ilimitada 24/7 para todos os módulos</p>
                  </div>
                  <div className="flex items-start gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
                    <CheckCircle2 className="text-brand-accent shrink-0 mt-1" size={20} />
                ...
                <div className="p-8 bg-gradient-to-r from-brand-accent/10 to-transparent border border-brand-accent/20 rounded-[32px] text-left flex flex-col gap-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-xl mb-1">Certificado de PNL Practitioner</h4>
                      <p className="text-brand-platinum/80">Emitido após aprovação no Exame 44 com SENA (nota mínima 7/10)</p>
                    </div>
                  </div>
      ...
      <section className="py-24 bg-brand-dark relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Onde você pode aplicar</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 bg-white/5 border border-white/10 rounded-[32px]">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Relacionamentos mais saudáveis</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Gestão emocional efetiva</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Eliminação de hábitos indesejados</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Clareza de objetivos e propósito</li>
              </ul>
            </div>
            
            <div className="p-8 bg-white/5 border border-white/10 rounded-[32px]">
              <h3 className="text-xl font-bold text-brand-accent mb-6">Profissional (Não-terapêutico)</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Vendas e negociações</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Liderança e gestão de equipes</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> RH e desenvolvimento organizacional</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Comunicação persuasiva</li>
              </ul>
            </div>
            ...
            <div className="p-8 bg-white/5 border border-white/10 rounded-[32px]">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Atendimento clínico estruturado</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Coaching com resultados mensuráveis</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Consultoria em desenvolvimento humano</li>
                <li className="flex items-start gap-2 text-brand-platinum/80"><ChevronRight className="text-brand-accent shrink-0 mt-1" size={16} /> Abertura de próprio negócio</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-brand-accent/5 border-y border-brand-accent/10 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="text-center md:text-left">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Você não arrisca nada. Exceto continuar do jeito que está.</h2>
            ...
            <p className="text-brand-platinum text-lg leading-relaxed">
              Se em 7 dias você não sentir que isso é exatamente o que você precisava, seja para uso pessoal ou profissional, devolvemos 100% do seu investimento. Sem perguntas, sem burocracia. <strong className="text-white">O risco é todo nosso.</strong> A transformação pode ser sua.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-brand-dark relative">
        <div className="max-w-3xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-brand-platinum">Tudo o que você precisa saber antes de tomar a sua decisão.</p>
          </div>
          <div className="space-y-4">
            {[
              { q: "Nunca estudei nada disso. Vou conseguir acompanhar?", a: "Sim. O método foi desenvolvido para quem está começando do zero. Cada conceito é explicado desde a base, com exemplos do dia a dia. E o SENA nunca se cansa de explicar de novo, de outro jeito, até você entender." },
              { q: "Já sou terapeuta/coach. Este curso agrega?", a: "Com certeza. Muitos alunos experientes relatam que nossa estrutura organizou conhecimentos que eles tinham de forma fragmentada. O diferencial é o SENA: finalmente um lugar para praticar sem arriscar clientes reais enquanto ainda não está fluente." },
              { q: "Quanto tempo tenho acesso?", a: "Vitalício. E inclui atualizações que fizermos no futuro — inclusive melhorias no SENA." },
              { q: "O certificado vale para trabalhar?", a: "Sim, para prática de PNL e coaching. O certificado é válido nacionalmente como comprovação de formação. Emitido apenas após aprovação no Exame 44 com SENA (nota mínima 7/10), atestando competência real, não apenas presença." },
              { q: "Preciso fazer prova?", a: "Avaliação prática com SENA (Aula 44). Você conduz uma sessão simulada, recebe nota e feedback detalhado. Necessário para Certificado de Competência, mas não para acesso ao conteúdo." },
              { q: "Como funciona o SENA tecnicamente?", a: "É um agente de IA integrado à área de membros. Você acessa por chat, escolhe o modo (paciente/instrutor/avaliador) e interage por texto, áudio ou vídeo. Funciona no celular e computador, sem instalar nada." },
              ...
              <div key={idx} className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden transition-all hover:border-brand-accent/30">
                ...
                >
                  ...
                  <ChevronDown className={`text-brand-accent shrink-0 transition-transform duration-300 ${openFaq === idx ? 'rotate-180' : ''}`} />
                </button>
                <AnimatePresence>
                  {openFaq === idx && (
                    <motion.div
      ...
      <section className="py-24 bg-white/5 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Como Funciona</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-8 bg-brand-dark border border-white/10 rounded-[32px] text-center relative">
              <div className="w-12 h-12 bg-brand-accent text-brand-dark font-bold text-xl rounded-full flex items-center justify-center mx-auto mb-6">1</div>
              <h3 className="text-xl font-bold text-white mb-4">Escolha sua ferramenta</h3>
              <p className="text-brand-platinum/80">PNL, Hipnoterapia ou ambos. Comece pelo que faz mais sentido para seu objetivo atual.</p>
            </div>
            
            <div className="p-8 bg-brand-dark border border-white/10 rounded-[32px] text-center relative">
              <div className="w-12 h-12 bg-brand-accent text-brand-dark font-bold text-xl rounded-full flex items-center justify-center mx-auto mb-6">2</div>
              <h3 className="text-xl font-bold text-white mb-4">Aprenda no seu ritmo</h3>
              <p className="text-brand-platinum/80">44 aulas gravadas, acesso vitalício. Estude quando e onde quiser.</p>
            </div>

            <div className="p-8 bg-brand-accent/10 border border-brand-accent/30 rounded-[32px] text-center relative">
              <div className="w-12 h-12 bg-brand-accent text-brand-dark font-bold text-xl rounded-full flex items-center justify-center mx-auto mb-6">3</div>
              <h3 className="text-xl font-bold text-white mb-4">Pratique com o SENA</h3>
              <p className="text-brand-platinum/80"><strong className="text-white">Seu ambiente de simulação 24/7.</strong> Quiz, diálogos imersivos, avaliação de vídeos, simulação de pacientes, exame de competência, tudo integrado.</p>
            </div>

            <div className="p-8 bg-brand-dark border border-white/10 rounded-[32px] text-center relative">
              <div className="w-12 h-12 bg-brand-accent text-brand-dark font-bold text-xl rounded-full flex items-center justify-center mx-auto mb-6">4</div>
              <h3 className="text-xl font-bold text-white mb-4">Aplique e transforme</h3>
              <p className="text-brand-platinum/80">Use para si, para outros, ou para construir uma nova carreira. Você decide.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-brand-dark relative">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Mesma qualidade de conteúdo. Sem a barreira de preço.</h2>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="p-4 text-white font-bold text-lg w-1/3">Cursos Tradicionais</th>
                  <th className="p-4 text-brand-accent font-bold text-xl w-1/3 bg-brand-accent/5 rounded-t-2xl border-x border-t border-brand-accent/20">IBSDH</th>
                </tr>
              </thead>
              <tbody className="text-brand-platinum">
                <tr className="border-b border-white/10">
                  ...
                  <td className="p-4 font-bold text-brand-accent bg-brand-accent/5 border-x border-brand-accent/20">R$ 297</td>
                </tr>
                <tr className="border-b border-white/10">
                  <td className="p-4 font-bold text-white">Formato</td>
                  <td className="p-4">Presencial, deslocamento</td>
                  <td className="p-4 bg-brand-accent/5 border-x border-brand-accent/20">Online, seu ritmo</td>
                </tr>
                <tr className="border-b border-white/10">
                  <td className="p-4 font-bold text-white">Foco</td>
                  <td className="p-4">Teoria e história</td>
                  <td className="p-4 bg-brand-accent/5 border-x border-brand-accent/20">Prática e aplicação</td>
                </tr>
                <tr className="border-b border-white/10">
                  <td className="p-4 font-bold text-white">Público</td>
                  <td className="p-4">Exclusivo, elitista</td>
                  <td className="p-4 bg-brand-accent/5 border-x border-brand-accent/20">Acessível, universal</td>
                </tr>
                <tr className="border-b border-white/10">
                  <td className="p-4 font-bold text-white">Prática</td>
                  <td className="p-4">"Faça com amigos" (se tiver)</td>
                  <td className="p-4 font-bold text-white bg-brand-accent/5 border-x border-brand-accent/20">SENA: simulação 24/7 ilimitada</td>
                </tr>
                <tr className="border-b border-white/10">
                  <td className="p-4 font-bold text-white">Feedback</td>
                  <td className="p-4">Esperar dias pelo professor</td>
                  <td className="p-4 font-bold text-white bg-brand-accent/5 border-x border-brand-accent/20">Instantâneo e específico</td>
                </tr>
                <tr>
                  <td className="p-4 font-bold text-white">Certificação</td>
                  <td className="p-4">Apenas presença</td>
                  <td className="p-4 font-bold text-white bg-brand-accent/5 rounded-b-2xl border-x border-b border-brand-accent/20">Competência demonstrada com IA (nota 7/10)</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="text-center mt-12 mb-16">
            <p className="text-brand-accent font-bold text-xl max-w-2xl mx-auto italic">"Mesma profundidade de conteúdo. Tecnologia que ninguém mais tem. Preço que democratiza o acesso."</p>
          </div>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a href="#matricula" className="w-full sm:w-auto text-center px-8 py-4 rounded-full bg-brand-accent text-brand-dark font-bold hover:scale-105 transition-transform">
              Quero começar pelo Practitioner
            </a>
            <Link to="/master-pnl" className="w-full sm:w-auto text-center px-8 py-4 rounded-full border border-white/20 text-white font-bold hover:bg-white/5 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="bg-white/5 border border-white/10 rounded-[40px] p-10 md:p-16 backdrop-blur-xl mt-12 relative overflow-hidden">
            ...
            <div className="flex justify-center items-baseline gap-2 mb-2">
              ...
              <span className="text-6xl md:text-8xl font-bold text-white tracking-tighter">24<span className="text-4xl md:text-6xl">,75</span></span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10 text-left">
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-brand-platinum/80 text-sm"><CheckCircle2 className="text-brand-accent" size={16} /> Acesso vitalício ao curso completo (44 aulas)</li>
                <li className="flex items-center gap-2 text-brand-platinum/80 text-sm"><CheckCircle2 className="text-brand-accent" size={16} /> Atualizações futuras sem custo</li>
                <li className="flex items-center gap-2 text-white font-bold text-sm"><span className="text-lg">🤖</span> SENA: prática ilimitada 24/7</li>
              </ul>
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-brand-platinum/80 text-sm"><CheckCircle2 className="text-brand-accent" size={16} /> Certificado de Competência</li>
                <li className="flex items-center gap-2 text-brand-platinum/80 text-sm"><CheckCircle2 className="text-brand-accent" size={16} /> Grupo de alunos</li>
                <li className="flex items-center gap-2 text-brand-platinum/80 text-sm"><CheckCircle2 className="text-brand-accent" size={16} /> Suporte por 12 meses</li>
              </ul>
            </div>
            ...
            <div className="mt-8 p-4 bg-brand-accent/10 border border-brand-accent/20 rounded-xl text-left">
              <p className="text-sm text-brand-platinum leading-relaxed">
                <strong className="text-brand-accent">⚡ Capacidade limitada:</strong> O SENA processa interações de forma personalizada. Quando atingirmos o limite técnico da turma, pausamos novas matrículas até expansão.
              </p>
            </div>
          </div>
        </div>
